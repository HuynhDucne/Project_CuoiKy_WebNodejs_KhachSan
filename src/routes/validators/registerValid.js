...
module.exports = [
    check('fullname')
    .exists().withMessage('Please fill the fullname field')
    .notEmpty().withMessage('Fullname fields must not be empty!'),
    ...
    check('confirm_pass')
    .exists().withMessage('Please fill the confirm password field')
    .notEmpty().withMessage('Confirm password fields must not be empty!')
    .isLength({min: 6}).withMessage('Password must have at least 6 characters!')
]