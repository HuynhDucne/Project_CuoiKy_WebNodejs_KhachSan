...
class PaymentController {
  ...
  async paymentHandle(req, res) {
    ...
    if(user){
      ...
      res.render('history_booking_user', {user, header: "header", bookingData, roomData, bookingId: newBooking._id, formattedCheckInDate, formattedCheckOutDate, phone_number_pay});
